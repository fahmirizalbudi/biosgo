...
Biosgo is a basic API service for basic crud cinema operations. Built in Go and Gin Web Framework, this project was created to learn. This project uses PostgreSQL as the database. Key features include:

## ✨ Features

- **⚡ Unlimited Requests:** Handle unlimited API requests without restrictions.
- **🎬 Movies Management:** Create, view, update, and delete movies; manege movies easily.
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/fahmirizalbudi/biosgo.git
   cd biosgo
   ```
